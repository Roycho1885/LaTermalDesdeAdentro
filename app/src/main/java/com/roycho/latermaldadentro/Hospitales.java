...
public class Hospitales extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		como2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/Ede2B"));
				startActivity(j);
			}
		});
		...
		como4.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/DexVu"));
				startActivity(j);
			}
		});
		...
		como6.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/rcUAv"));
				startActivity(j);
			}
		});
		...
		como8.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/M5qyY"));
				startActivity(j);
			}
		});
		...
		como10.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/Z58vFe5zfWt"));
				startActivity(j);
			}
		});
		...
		como12.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/KZKCf"));
				startActivity(j);
			}
		});
