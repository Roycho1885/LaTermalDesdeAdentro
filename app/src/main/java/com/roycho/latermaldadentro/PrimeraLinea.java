...
public class PrimeraLinea extends Activity {
    ...
    static String feedUrl = "https://diarioprimeralinea.com.ar/feed/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.primeralinea);

        if (checkConnectivity())
        {

            setTitle("Diario Primera Linea");
            ...
            btn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (lv.getAdapter() != null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(PrimeraLinea.this,AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
