...
public class DiariolaRegion extends Activity {
    ...
    static String feedUrl = "https://www.eldiariodelaregion.com.ar/feed/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.diariolaregion);

        if (checkConnectivity())
        {

            setTitle("El Diario de la Región");
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (lv.getAdapter() != null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(DiariolaRegion.this,AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
        ...
        ListView lv =  findViewById(R.id.lstData);
    ...
    private void loadData() {
        ...
        new Thread(new Runnable(){
            @Override
            public void run() {
                XMLParsernoti parser = new XMLParsernoti(feedUrl);
