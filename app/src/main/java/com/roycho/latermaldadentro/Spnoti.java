...
public class Spnoti extends Activity {
	...
	static String feedUrl = "https://www.primerochaco.com/feed/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.primerochaco);

     if (checkConnectivity())
      {
        	  	
        setTitle("PrimeroChaco");
        ...
        btn.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
    			...
    			if (lv.getAdapter() != null) {
    				AlertDialog.Builder builder = new AlertDialog.Builder(Spnoti.this,AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
