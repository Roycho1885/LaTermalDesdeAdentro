	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		como2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/XU1Dd9TUWAB2"));
				startActivity(j);
			}
		});
		...
		como4.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/FqJJip1H79J2"));
				startActivity(j);
			}
		});
		...
		como6.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				Intent j = new Intent(Intent.ACTION_VIEW,Uri.parse("https://goo.gl/maps/nWhf5wvmpB72"));
				startActivity(j);
			}
		});
